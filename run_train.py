...
parser.add_argument('--max_length_sen', type=int, default=256)  # 最大长度
parser.add_argument('--max_checkpoint', type=int, default=4096) # 跑4096个256steps
parser.add_argument('--sampled_num', type=int, default=1200)
parser.add_argument('--batch_size', type=int, default=6)
parser.add_argument('--per_checkpoint', type=int, default=256)  # 每256验证一次
...
parser.add_argument('--breakpoint', type=int, default=-1)   # -1 从头训练
